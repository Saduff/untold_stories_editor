...
marknote.Attribute = function (name, value) {
    ...
    this.name = name;
    this.value = marknote.Util.nothingToBlank(value);
};
...
marknote.Attribute.prototype.getValue = function () {
    return marknote.Util.nothingToBlank(this.value);
};
marknote.Attribute.prototype.getEncodedValue = function () {
    return marknote.Util.encodeXMLCustom(marknote.Util.nothingToBlank(this.value));
};
marknote.Attribute.prototype.getDecodedValue = function () {
    return marknote.Util.decodeXMLCustom(marknote.Util.nothingToBlank(this.value));
};
...
marknote.Element.prototype.getAttributeValue = function (name) {
    ...
    return attrib ? attrib.getDecodedValue() : "";
};
...
marknote.Util.encodeXMLCustom = function(str) {
...
marknote.Util.decodeXMLCustom = function(str) {
    if (typeof str !== "string") return str;
    return str.replace(/&#13;/g, '\\n')
                .replace(/&quot;/g, '"')
                .replace(/&gt;/g, '>')
...
marknote.Writer.prototype.outputElement = function (elem, level, indent) {
    ...
    for (var a = 0; a < elem.getAttributes().length; a++) {
        ...
        output += " " + attrib.getName() + marknote.constants.EQUALS + marknote.constants.DQUOTE + attrib.getEncodedValue() + marknote.constants.DQUOTE;
    }
